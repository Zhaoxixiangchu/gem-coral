...
public interface GemConstant {
	...
	public interface MediaType{
		...
		public String APPLICATION_XWWW_FORM_URLENCODED = "application/x-www-form-urlencoded";
		public String APPLICATION_XWWW_FORM_URLENCODED_UTF_8 = "application/x-www-form-urlencoded;charset=UTF-8";
