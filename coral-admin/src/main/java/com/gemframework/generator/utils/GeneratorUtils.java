...
import com.gemframework.common.constant.DictionaryKay;
...
public class GeneratorUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(Map<String, String> column : columns){
			...
			//列的数据类型，转换成Java类型
			String dataType = generatorUtils.dictionaryService.getByKey(DictionaryKay.DATABASE_TYPE);
			String attrType = GemStringUtils.getKVFromJson(dataType,column.get("dataType"));
			if(attrType==null){
				attrType = "VARCHAR";
			}
